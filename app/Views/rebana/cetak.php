...
<body style="font-size:13px;">
    ...
    <table style="border: 1px solid black;">
        <tr style="border: 1px solid black;">
            ...
            <th style="border: 1px solid black;padding:5px;">Panitia</th>
            <th style="border: 1px solid black;padding:5px;">Telepon</th>
            <th style="border: 1px solid black;padding:5px;">Penjemputan</th>
        ...
        <?php foreach ($data['data'] as $k => $i) : ?>
            <tr style="border: 1px solid black;">
                ...
                <td style="border: 1px solid black;padding:5px;"><?= hari(date('l', $i['tgl']))['indo']; ?> <?= $i['pasaran']; ?>, <?= date('d', $i['tgl']); ?> <?= bulan(date('m', $i['tgl']))['bulan']; ?> <?= date('Y', $i['tgl']); ?></td>
                ...
                <td style="border: 1px solid black;padding:5px;"><?= $i['panitia']; ?></td>
                <td style="border: 1px solid black;padding:5px;"><?= $i['telepon']; ?></td>
                <td style="border: 1px solid black;padding:5px;"><?= $i['penjemputan']; ?></td>
